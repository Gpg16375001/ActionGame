...
void GameIGame( void )
{
	...
	obj[O_HOLE+4].idno = ID_HOLE2 ;						// îwåiÇÃåƒÇ—èoÇµ
	obj[O_HOLE+4].mode = 0 ;							// îwåiÇÃèâä˙ÉZÉbÉgÇÃåƒÇ—èoÇµ
	obj[O_HOLE+4].cnt = 4 ;								// îwåiÇÃèâä˙ÉZÉbÉgÇÃåƒÇ—èoÇµ

	obj[O_BOO].idno = ID_BOO ;							// îwåiÇÃåƒÇ—èoÇµ
	obj[O_BOO].mode = 0 ;								// îwåiÇÃèâä˙ÉZÉbÉgÇÃåƒÇ—èoÇµ
	obj[O_BOO].xp = -100 ;

	obj[O_SNOW].idno = ID_SNOW ;						// îwåiÇÃåƒÇ—èoÇµ
	obj[O_SNOW].mode = 0 ;								// îwåiÇÃèâä˙ÉZÉbÉgÇÃåƒÇ—èoÇµ
